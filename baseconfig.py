...
popservername = 'pop3.xplore.loc'							# другие примеры в каталоге altconfigs/
...
fetchEncoding = 'latin-1'									# как декодировать и сохранять полный текст сообщения (ascii?)
...
mainTextEncoding = 'ascii'									# основной текст сообщения (None = спрашивать)
attachmentTextEncoding = 'ascii'							# все текстовые вложения (utf-8, latin-1)
...
headersEncodeTo = None										# как кодировать не-ASCII заголовки при передаче (None = UTF-8)
...
fetchlimit = 50												# максимальное число загружаемых заголовков/сообщений
