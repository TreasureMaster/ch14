...
# записываться лог в файл или консоль; если не определен в конфигурационном
# файле или имеет значение False, то логгирование будет происходить в консоль;
# значение True - в файл ./TraceLog/trace.log
# ---------------------------------------------------------------------------- #
...
# эти значения будут действовать на пртяжении всего сеанса;
